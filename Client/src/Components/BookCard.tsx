...
function BookCard({bookGrid}:{bookGrid : Book}) {
  ...
  return (
    <div className='p-2 m-4 w-52 h-96 bg-gray-600 rounded-xl flex items-center flex-col relative'>
            ...
            <button  className='hover:bg-blue-500 hover:text-white w-24 bottom-0 absolute mb-4 text-blue-500 border-2 bg-transparent p-2 rounded-l-2xl rounded-r-2xl border-blue-500'>
              <Link to={`/book/${bookGrid.id}`} params={{bookId : bookGrid.id}}>Details</Link></button>
